...
#define RESET_BUTTON_PIN 2 // Set GPIO pin for the button (you can change this to any free GPIO pin)
...
// Server URL
const char* serverURL = "http://192.168.202.252:5000";
...
void setup() {
  ...
  // Initialize push button as input with an internal pull-up resistor
...
void loop() {
  // Check if the reset button is pressed (button pressed when pin reads LOW)
